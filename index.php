...
<html>
	...
	<body>
		<nav>
			<div class="nav_top">
				<h1>The <span style="color: #e6b800">DREAM</span> Hotel </h1>
			</div>
			<div class="nav_bottom">
			   <ul>
				<li><a href="index.php">HOME</a>
				<li><a href="#rooms_and_rates">ROOM GALLERY</a></li>
				<li><a href="#image_gallery">IMAGE GALLERY</a>
		...
		<h2 class="welcome2">Find our friendly welcoming reception</h2><br><br><br>

		<section id="rooms_and_rates">
		...
		<div class="basic_box">
			<div class="row">
  				...
  				<div class="column">
    				<img src="images/A51.jpg" alt="Forest" style="width:100%">
  				</div>
  				<div class="column">
    				<img src="images/A42.jpg" alt="Mountains" style="width:100%">
  				</div>
			</div>
			<div class="row">
  				<div class="column">
		...
		<div class="row">
  			...
  			<div class="column">
    			<img src="images/A211.jpg" alt="Forest" style="width:100%">
  			</div>
  			<div class="column">
